...
export const fetchTradelicences = (params) => async (dispatch) => {
  console.log("filters in action:", params);
  let response = await Digit.TLService.tradelicenceSearch(params);
  console.log("response>>", response);
  dispatch({
    type: SEARCH_TRADELICENCE,
    payload: { response },
  });
};
